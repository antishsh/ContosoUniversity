                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Instructor databaseInistructor = await _context.Instructors.FirstOrDefaultAsync(i => i.ID == databaseValues.InstructorID);
                            ModelState.AddModelError("InistructorID", $"Current value: {databaseInistructor?.FullName}");
                        }
